...
function closeReaderPage({ updateRoute = true } = {}) {
  ...
  if (state.workspace === 'notes') { openNotesWorkspace({ restore: true }); syncNotesRoute({ replace: true }); } else if (state.workspace === 'manage') { openManage(); } else if (state.workspace === 'timeline') { openTimeline(); } else loadContent();
